...
namespace {
struct qt_meta_tag_ZN9caelestia8internal19CachingImageManagerE_t {};
} // unnamed namespace

template <> constexpr inline auto caelestia::internal::CachingImageManager::qt_create_metaobjectdata<qt_meta_tag_ZN9caelestia8internal19CachingImageManagerE_t>()
{
    namespace QMC = QtMocConstants;
    QtMocHelpers::StringRefStorage qt_stringData {
        "caelestia::internal::CachingImageManager",
        "QML.Element",
        "auto",
        "itemChanged",
        "",
    ...
    QtMocHelpers::UintData qt_properties {
        ...
        // property 'cacheDir'
        QtMocHelpers::PropertyData<QUrl>(13, 0x80000000 | 14, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag | QMC::StdCppSet | QMC::Required, 1),
        // property 'path'
        QtMocHelpers::PropertyData<QString>(10, QMetaType::QString, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 2),
        // property 'cachePath'
        QtMocHelpers::PropertyData<QUrl>(15, 0x80000000 | 14, QMC::DefaultPropertyFlags | QMC::EnumOrFlag, 3),
    };
...
Q_CONSTINIT const QMetaObject caelestia::internal::CachingImageManager::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9caelestia8internal19CachingImageManagerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9caelestia8internal19CachingImageManagerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN9caelestia8internal19CachingImageManagerE_t>.metaTypes,
    nullptr
} };

void caelestia::internal::CachingImageManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
...
const QMetaObject *caelestia::internal::CachingImageManager::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *caelestia::internal::CachingImageManager::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9caelestia8internal19CachingImageManagerE_t>.strings))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}

int caelestia::internal::CachingImageManager::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void caelestia::internal::CachingImageManager::itemChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void caelestia::internal::CachingImageManager::cacheDirChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void caelestia::internal::CachingImageManager::pathChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void caelestia::internal::CachingImageManager::cachePathChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 3, nullptr);
}

// SIGNAL 4
void caelestia::internal::CachingImageManager::usingCacheChanged()
{
